...
$('#daterange-ranges1').daterangepicker({
   ...
   function(start, end) {
       $('#daterange-ranges1 span').html(start.format('MMMM D') + ' - ' + end.format('MMMM D'));
        ...
        setTimeout(function () {
            $("#loadExpenses").hide();
            loadExpenses($("#DepStat").val(),$("#daterange-ranges1").data('daterangepicker').startDate.format('YYYY-MM-DD'),$("#daterange-ranges1").data('daterangepicker').endDate.format('YYYY-MM-DD'));
            $("#expenses").show();
        },1000);
   }
   );
   ...
   $("#DepStat").change(function() {
       $("#loadExpenses").hide();
       loadExpenses($(this).val(),$("#daterange-ranges1").data('daterangepicker').startDate.format('YYYY-MM-DD'),$("#daterange-ranges1").data('daterangepicker').endDate.format('YYYY-MM-DD'));
       $("#expenses").show();
   });
