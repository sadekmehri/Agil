$(document).ready(function() {
    ...
    function generate_table() {
        ...
        for (var i = 0; i < displayRecords.length; i++) {
            ...
            var htmlStr = "<li class='feed-item' id='" + displayRecords[i].Date + "' name='" + displayRecords[i].Id + "'>";
