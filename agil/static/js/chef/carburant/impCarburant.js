$(document).ready(function() {
    ...
    $("#idForm").submit(function(e) {
        ...
        $.ajax({
            url: "/chef/recette/carburant/dataCarburant",
            type: 'post',
    ...
    function Data(data) {
        ...
        $.each(data, function(i, d) {
            ...
            $.each(d, function(i, d) {
                Lit += d.Litre;
                Tot += d.Vente;
                appendToResult = appendToResult.concat(d.Pompe + "</td>" +
                    "<td>" + d.Groupe + "</td>" +
                    "<td>" + d.Voie + "</td>" +
                    "<td>" + d.Citerne + "</td>" +
                    "<td>" + d.Carburant + "</td>" +
            ...
            appendToResult = appendToResult.concat(
                ...
                "</tr>" +
                "<td class='bg-dark' colspan='7'>Total</td>" +
                "<td>" + Lit + " L" + "</td>" +
                "<td></td>" +
    ...
    function generate(date) {
        ...
        const pageContent = function (data) {
            ...
            pdf.text(55, 40, $("#codes").text());
            pdf.setFontSize(14);
            pdf.text(700, 33, 'Recette Carburant');
            pdf.text(725, 53, date);
        ...
        pdf.save(date + "_Recette_Carburant.pdf");
    }
