$(document).ready(function() {
    ...
    $("#idForm").submit(function(e) {
        ...
        $.ajax({
            url: "/chef/absence/imprimerListe/data",
            type: 'post',
    ...
    function Data(data) {
        ...
        $.each(data, function(i, d) {
            ...
            appendToResult = appendToResult.concat("</tr><td colspan='7'></td></tr>");
    ...
    function generate(date) {
        ...
        const pageContent = function (data) {
            ...
            pdf.setFontSize(14);
            pdf.text(700, 53, 'Liste d\'absence');
            pdf.text(670, 33, date + "_" + currrent_date());
        ...
        pdf.save(date + "_"+currrent_date()+"_Absence_"+getStation()+".pdf");
    }
